...
//                .failureHandler((request, response, e) -> response.sendRedirect(request.getContextPath() + "/login?error"))
                ...
                .defaultSuccessUrl("/authenticated", true) // URL to return if login is successful
